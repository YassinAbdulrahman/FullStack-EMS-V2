...
const Sidebar = () => {
  ...
  const navItems = [
    ...
    { name: "Leave", href: "/leaves", icon: FileTextIcon },
  ...
  const sidebarContent = (
    <>
      ...
      {/* Navigation List */}
      <div className="flex-1 px-3 space-y-0.5 overflow-y-out">
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              <item.icon
                className={` w-[17px] h-[17px] shrink-0 text-indigo-300 ${isActive ? "text-indigo-300" : "text-slate-400 group-hover:text-slate-300"}`}
              />
